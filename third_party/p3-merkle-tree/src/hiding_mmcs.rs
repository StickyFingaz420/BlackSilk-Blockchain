    ...
    StandardUniform: Distribution<P::Value>,
{
    ...
    fn commit<M: Matrix<P::Value>>(
        ...
        // BlackSilk patch (third_party/README.md, AUDIT.md ZK-F11): release the
        // RNG spin lock before the (parallel) Merkle tree construction, so no
        // rayon work runs while the lock is held.
        let salted_inputs = {
