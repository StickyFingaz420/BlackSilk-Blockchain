...
| G8 | **Wallet and private-transaction testing** | e2e tests for v1, PX, vault; wallet-review.md findings closed or accepted | In progress: W-1 to W-4 fixed; W-5 open |
...
| G14 | **Rollback and incident-response plan** | Who decides, how nodes are told, how a bad release is withdrawn, how a consensus bug is handled (halt, fix, reset) | **Not started:** only the reset rollback exists |
